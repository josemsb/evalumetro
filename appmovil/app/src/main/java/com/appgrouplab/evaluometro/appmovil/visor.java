...
public class visor extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.toolbarvisor,menu);
        ...
        if (credencial.isEmpty()){
            ...
            mAdapterVisor.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    //eleccion("Regístrate o inicia sesión para acceder.\nEs gratuito anímate, además podras votar por tu candidato preferido:");
    ...
    public class cargarDistrito extends AsyncTask<String, Void, String> {
        ...
        protected  void onPostExecute(String result){
            ...
            distritoVisor.setNombre("Selecciona Distrito");
            distritos.add(distritoVisor);
            distritonombres.add("Selecciona Distrito");
